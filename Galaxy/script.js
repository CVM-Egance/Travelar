...
const sunData = {
    ...
    desc: "The star of the solar system and its center, accounting for 99.8% of the system's mass and providing the energy needed for life."
};
...
const planetData = [
    { 
        ...
        tilt: 0.03,
        stats: { diameter: "4,879 km", dist: "57.9 M km", period: "88 Days" },
        desc: "The smallest planet in the solar system and the closest to the Sun, its surface is covered with craters."
    },
    { 
        name: "Venus", 
        nameEn: "Venus",
        ...
        tilt: 177.3,
        stats: { diameter: "12,104 km", dist: "108.2 M km", period: "225 Days" },
        desc: "Earth's twin, characterized by a thick atmosphere and extreme heat."
    },
    { 
        name: "Earth", 
        nameEn: "Earth",
        ...
        tilt: 23.5,
        stats: { diameter: "12,742 km", dist: "149.6 M km", period: "365.25 Days" },
        desc: "Our only planet that supports life, characterized by blue water and land."
    },
    { 
        name: "Mars", 
        nameEn: "Mars",
        ...
        tilt: 25.2,
        stats: { diameter: "6,779 km", dist: "227.9 M km", period: "687 Days" },
        desc: "The Red Planet, home to the largest mountains and valleys in the solar system."
    },
    { 
        name: "Jupiter", 
        nameEn: "Jupiter",
        ...
        tilt: 3.1,
        stats: { diameter: "139,820 km", dist: "778.6 M km", period: "11.8 Years" },
        desc: "A gas giant and the largest planet, famous for its Great Red Spot."
    },
    { 
        name: "Saturn", 
        nameEn: "Saturn",
        ...
        tilt: 26.7, 
        rings: true,
        stats: { diameter: "116,460 km", dist: "1.4 B km", period: "29.4 Years" },
        desc: "The jewel of the solar system, famous for its magnificent and stunning rings."
    },
    { 
        name: "Uranus", 
        nameEn: "Uranus",
        ...
        tilt: 97.8, 
        stats: { diameter: "50,724 km", dist: "2.9 B km", period: "84 Years" },
        desc: "The cold ice giant, orbiting the Sun while tilted on its side."
    },
    { 
        name: "Neptune", 
        nameEn: "Neptune",
        ...
        tilt: 28.3,
        stats: { diameter: "49,244 km", dist: "4.5 B km", period: "164.8 Years" },
        desc: "The deep blue Ice Giant and the most distant, characterized by very stormy winds."
    }
];
...
function showPlanetInfo(data) {
    ...
    if (data.nameEn === "Sun") {
        distLabel.innerText = "Location:";
        periodLabel.innerText = "Rotation Cycle:";
    } else {
        distLabel.innerText = "Distance from Sun:";
        periodLabel.innerText = "Rotation Period:";
    }
