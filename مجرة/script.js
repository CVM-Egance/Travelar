...
// 2. الشمس الإجرائية (Procedural Sun with Enhanced Shaders)
const sunData = {
    name: "الشمس",
    nameEn: "Sun",
    size: 30,
    ...
    desc: "نجم المجموعة الشمسية ومركزها، يمثل 99.8% من كتلة النظام بالكامل ويوفر الطاقة اللازمة للحياة."
};
...
function createSun() {
    ...
    // Sun Colors - Vivid Yellow Radiant (أصفر فاقع ومتوهج)
    const sunUniforms = {
        uTime: { value: 0 },
    ...
    const fragmentShader = `
        ...
        void main() {
            ...
            // 3. Brightness Boost (زيادة السطوع العام للوهج)
            color *= 1.45; 
    ...
    // Golden Radiant Glow (هالة ذهبية ساطعة)
    
    // Layer 1: Bright Inner Glow (توهج داخلي ساطع)
    ...
    // Layer 2: Main Golden Halo (هالة ذهبية كبرى)
    ...
    // Layer 3: Radiant Bloom Sprite (توهج مشع ناعم)
...
const planetData = [
    { 
        ...
        desc: "أصغر كواكب المجموعة الشمسية وأقربها إلى الشمس، سطحه مليء بالفوهات."
    },
    { 
        name: "الزهرة", 
        nameEn: "Venus",
        ...
        desc: "توأم الأرض، يتميز بغلاف جوي كثيف وحرارة شديدة جداً."
    },
    { 
        name: "الأرض", 
        nameEn: "Earth",
    ...
    { 
        ...
        desc: "عملاق غازي وأكبر الكواكب، يتميز ببقعته الحمراء العظيمة."
    },
    { 
        name: "زحل", 
        nameEn: "Saturn",
        ...
        desc: "درة المجموعة الشمسية، يشتهر بحلقاته الرائعة والمذهلة."
    },
    { 
        name: "أورانوس", 
        nameEn: "Uranus",
        ...
        desc: "العملاق الجليد البارد، يدور حول الشمس وهو مائل على جنبه."
    },
    { 
        name: "نبتون", 
        nameEn: "Neptune",
        ...
        desc: "الكوكب الأزرق العميق والأكثر بعداً، يتميز برياح عاصفة جداً."
    }
];
...
// 5. الأحداث والتفاعل (Events & Interaction)
